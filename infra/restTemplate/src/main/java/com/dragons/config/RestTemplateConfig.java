...
public class RestTemplateConfig {
  ...
  private RestTemplate createRestTemplate(
    ...
    return builder
        ...
        .additionalInterceptors(new MdcInterceptor(), new RequestResponseLoggingInterceptor(maskingFacade, isProd))
        .build();
  }
  ...
  public RestTemplate restTemplate(
      ...
      MaskingFacade maskingFacade,
      RestTemplateProperties properties) {
    return createRestTemplate(builder, env, Constants.DEFAULT, maskingFacade, properties);
  }
}
